...
class gacha_pool:
    ...
    def gacha_attribute(self, pool, amount):
        if amount > 10:
            amount = 10
        info = {"5星": 0, "4星": 0, "3星": 0}
    ...
    def gacha_single(self, pool, amount):
        if amount > 10:
            amount = 10
        info = {"5星": 0, "4星": 0, "3星": 0}
        rnd_seed = round(time.time(), 3)
        ...
        for i in range(amount):
            ...
            if i != amount - 1:
                if rnd >= 0 and rnd <= 15000:
                    item = random.choice(self.char_list[pool]["five_pu"])
                    info["5星"] += 1
                elif rnd > 15000 and rnd <= 50000:
                    item = random.choice(self.char_list[pool]["five"])
                    info["5星"] += 1
    ...
    def gacha_three(self, pool, amount):
        if amount > 10:
            amount = 10
        info = {"5星": 0, "4星": 0, "3星": 0}
        rnd_seed = round(time.time(), 3)
